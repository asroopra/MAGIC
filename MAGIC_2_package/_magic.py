...
'''
combine modules:
    magic_calculations: calculate_padj, get_d_arg
    magic_graphics: histplots, summary fig
    magic_results: write_gmx, write_target_data
    file_handler
    
   
make summary fig(s) based on FDR cutoff:
    2 panels:
       order TFs by padj
       order TFs by score
